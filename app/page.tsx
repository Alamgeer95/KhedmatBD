          ...
          <div className="relative rounded-3xl bg-gradient-to-br from-[#b88a4e] to-[#c29660] text-[#0e1a30] p-8 md:p-16 text-center overflow-hidden shadow-2xl shadow-[#b88a4e]/20">
            ...
            <div className="relative z-10">
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link href="/auth/signup" className="btn btn-lg btn-outline border-[#f0f5ff]/50 text-[#f0f5ff] hover:bg-white/10 rounded-full hover:-translate-y-1 transition-all duration-300">
                  প্রোফাইল তৈরি করুন
                </Link>
              </div>
            </div>
